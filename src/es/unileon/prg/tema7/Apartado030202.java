...
public class Apartado030202 extends Apartado {
	...
	public void ejercicio05() {
		...
		cuenta1.anyadir(new Titular("115458222D","Pedro",35,1000));
		cuenta1.anyadir(new Titular("577225588G","Ana",34,100));
		miBanco.anyadir(cuenta1);

		CuentaBancaria cuenta2 = new CuentaBancaria(0);
		cuenta2.anyadir(new Titular("74992586Y","Carlos",18,500));
