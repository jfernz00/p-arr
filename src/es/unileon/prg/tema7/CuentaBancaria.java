...
public class CuentaBancaria{
    ...
    public boolean anyadir(Titular titular) {
		...
		for(int i=0; i <NUM_MAX_TITULARES; i++){
    ...
    public void sacar (int cantidad){
		...
		if(cantidad > this.saldo){
			System.out.println("No hay suficientes fondos en la cuenta del titular "+ this.titulares[0]);
		}
		if(this.titulares[0].obtenerEdad() >=18){
			this.saldo -=cantidad;
		}else{
			System.out.println("el titular principal "+ this.titulares[0]+" no es mayor de edad" );
		}
